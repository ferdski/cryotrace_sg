...
import TransitShipperTableDate from './RenderTransitShipperTableDate';

function TransitShipperDate() {
  ...
  return (
    <div className="containers-list">
      ...
      {records.length > 0 && <TransitShipperTableDate records={records} />}
    </div>
  );
}

export default TransitShipperDate;
