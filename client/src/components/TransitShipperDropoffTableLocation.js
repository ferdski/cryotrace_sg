...
import TransitShipperDropoffTableLocation from './RenderTransitShipperDropoffTableLocation';

function TransitShipperDropoffLocation() {
  ...
  return (
    <div className="containers-list">
      ...
      {records.length > 0 && <TransitShipperDropoffTableLocation records={records} />}
    </div>
  );
}

export default TransitShipperDropoffLocation;
