...
import TransitShipperDropoffTableDate from './RenderTransitShipperDropoffTableDate';

function TransitShipperDropoffDate() {
  ...
  return (
    <div className="containers-list">
      ...
      {records.length > 0 && <TransitShipperDropoffTableDate records={records} />}
    </div>
  );
}

export default TransitShipperDropoffDate;
